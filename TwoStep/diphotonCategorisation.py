...
stackHist = r.THStack('stackHist', 'Stacked 1D histogram')
...
sigScoreHist.SetFillColor(r.kRed)
#sigScoreHist.Draw('hist')
# bkgScoreHist.SetLineColor(r.kRed)
bkgDiphoScoreHist.SetFillColor(r.kBlue)
bkgGjetScoreHist.SetFillColor(r.kGreen)
bkgQCDScoreHist.SetFillColor(r.kViolet)
bkgDiphoScoreHist.SetMarkerStyle(21)
bkgGjetScoreHist.SetMarkerStyle(21)
bkgQCDScoreHist.SetMarkerStyle(21)
bkgDiphoScoreHist.SetMarkerColor(r.kBlue)
bkgGjetScoreHist.SetMarkerColor(r.kGreen)
bkgQCDScoreHist.SetMarkerColor(r.kViolet)
