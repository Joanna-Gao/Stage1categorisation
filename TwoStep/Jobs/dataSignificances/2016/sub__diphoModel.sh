...
#inputs
CMD="python dataSignificances.py -t /home/hep/jg4814/CMSSW_10_2_0//2016/trees -d dataTotal.pkl -s signifTotal.pkl --intLumi 35.9 --className jetModel.model -m diphoModel.model "
